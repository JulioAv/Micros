...
void main(void) {
    ...
    while (1){
        UART_write("Buenas jovenes \r");
        _delay((unsigned long)((50)*(8000000/4000.0)));
        UART_write("Que accion desea ejecutar? \r");
        _delay((unsigned long)((50)*(8000000/4000.0)));
        UART_write("[1] Desplegar Cadena de Caracteres \r");
        _delay((unsigned long)((50)*(8000000/4000.0)));
        UART_write("[2] Cambiar PORTA \r");
        _delay((unsigned long)((50)*(8000000/4000.0)));
        UART_write("[3] Cambiar PORTB \r");
