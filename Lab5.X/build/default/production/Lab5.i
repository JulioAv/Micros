...
main:
    ...
    bcf ((OPTION_REG) and 07Fh), 4 ; Condifuración del TMR0 con prescaler 2
    bsf ((OPTION_REG) and 07Fh), 3
    ...
    bsf ((INTCON) and 07Fh), 5 ; Interrupciones del TMR0
...
loop:
    BANKSEL INTCON
    btfss ((INTCON) and 07Fh), 0 ; Verificar si hay interrupción
    goto $+4
