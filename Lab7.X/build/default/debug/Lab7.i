...
int centena(){
    if ((0 <= PORTA) || (PORTA < 100)){
        cen = 0;
    }
    else if ((100 <= PORTA) || (PORTA < 200)){
        cen = 1;
    }
    else if (200 <= PORTA){
        cen = 2;
...
int decena(){
    ...
    else if ((60 <= cont) || ( cont < 70)){
        dec = 6;
        uni = (cont - 60);
    }
    else if ((70 <= cont) || ( cont < 80)){
        dec = 7;
        uni = (cont - 70);
    }
    else if ((80 <= cont) || ( cont < 90)){
        dec = 8;
        uni = (cont - 80);
    }
    else if ((90 <= cont) || ( cont < 100)){
        dec = 9;
        uni = (cont - 90);
    }
    return dec, uni;
